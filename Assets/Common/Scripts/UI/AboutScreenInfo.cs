...
public class AboutScreenInfo
{
    ...
    public AboutScreenInfo()
    {
        ...
        var description = "\n<size=26>Описание:</size>";
        var keyFunctionality = "<size=26>Основные возможности:</size>";
        var targets = "<size=26>:</size>";
        var instructions = "<size=26>Инструкция:</size>";
        var footer =
        ...
        mDescriptions.Add(
            "GroundPlane",
            description +
            "\nДанное приложение позволяет просмотреть 3D модели" +
            "мебели." +
            "\n\n" +
            keyFunctionality +
            "\n• Вы можете выбрать, расположить и осмотреть 3D модели мебели" +
            targets +
            "\n" +
            "\n\n" +
            instructions +
            "\n• Запустите приложение" +
            "\n• Наведите камеру на плоскую поверхность" +
            "\n• Нажмите на экран для того, что бы разместить объект" +
            "\n• Зажмите и перемещайте объект" +
            "\n• Используйте меню для выбора объекта" +
            "\n\n" +
            footer + "\n");
